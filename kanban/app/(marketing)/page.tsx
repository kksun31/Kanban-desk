    ...
    return(
        <div className="flex items-center justify-center flex-col">
            ...
            <div className = { cn(
                ...
                Сотрудничайте, управляйте проектами и достигайте новых 
                вершин продуктивности. От бизнеса до домашнего офиса ваша команда
                работает уникально - выполняйте все это с помощью Taskify.
            </div>
